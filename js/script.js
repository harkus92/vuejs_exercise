  ...
  collection :
  {
    ...
    items : [
        ...
        data : [
          ...
          {name : "imagen", value : "https://images-na.ssl-images-amazon.com/images/M/MV5BN2EyZjM3NzUtNWUzMi00MTgxLWI0NTctMzY4M2VlOTdjZWRiXkEyXkFqcGdeQXVyNDUzOTQ5MjY@._V1_UX182_CR0,0,182,268_AL_.jpg", prompt : "Imagen pelicula"}
        ]
	    },
	    {
        ...
        data : [
          ...
          {name : "imagen", value : "https://i.pinimg.com/originals/a7/2d/2c/a72d2cb9c2e8b5f88b6281188ee68cdc.jpg", prompt : "Imagen pelicula"}    
        ]
	    },
	    {
        ...
        data : [
          ...
          {name : "imagen", value : "http://www.elmulticine.com/imagenes/noticias/5/juego-tronos-picc.jpg", prompt : "Imagen pelicula"}    
        ]
	    }
    ]
  }
